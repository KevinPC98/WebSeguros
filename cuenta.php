...
?>
	...
	<div class="cuerpo">
		<div class="tab">
			...
			<button class="tablinks" id="pestania3"><a href="iniciarSesion.php" style="text-decoration: none; color: rgb(255,255,255)">Salir</a></button>
		</div>
		...
		<div id="inicio" class="tabcontent" align="center">
			...
			<?php
				...
				<p align="center">Si desea borrar su cuenta por algún motivo, haga click <a href="eliminarUsuario.php"><b>aquí</b></a></p>';
		...
		<div id="detalleSeguro">
			<button class="salir" name="salir" style="position: relative; background-color: rgb(0,45,255); color: rgb(255,255,255); border-style: none; padding: 15px;" onclick="desactivar();"><b>Salir</b></button>
